...
namespace LocaFacil.Controllers
{
    public class TelefonesController : Controller
    {
        ...
        public TelefonesController(LocaFacilContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ddd,numero")] Telefone telefone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ddd,numero")] Telefone telefone)
        {
            if (id != telefone.Id)
            {
                return NotFound();
